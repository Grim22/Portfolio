    ...
    <div id="contact" className="contact-container sticky">
        <div className="contact bg-transparent  h-auto w-full  flex flex-col p-10 md:max-w-screen-xl lg:p-20 rounded-3xl ">
            <div className="title-container h-auto w-full flex  flex-col-reverse items-center text-center lg:flex-row lg:justify-between">
                <div className="title text-green-500 flex items-center text-5xl font-SFbold py-3">
                    Contact me.
                </div>
                <div className="pic-container ">
                    <img className='h-40' src={callme} alt="" />
                </div>
            </div>
            <div className="grid h-auto grid-rows-5 grid-cols-2 sm:h-[1400px] md:h-[50vh] lg:h-[80vh] xl:h-[747px] w-full mt-24 sm:grid-rows-6 sm:grid-cols-2  md:grid-rows-3 md:grid-cols-4 gap-5">
                <Link to="https://linkedin.com/in/allen-bandian-096685169/" target='_blank' className="bg-blue-600 sm:h-[238px
                ] rounded-3xl col-span-2 md:col-span-2 drop-shadow-lg flex items-center justify-center hover:bg-blue-700">
                    <CiLinkedin  className='h-[40%] w-auto text-white'/>
                </Link>
                <div className="bg-violet-700 sm:h-[238px
                ] rounded-3xl row-span-2 md:row-span-2 drop-shadow-lg flex items-center justify-center">
                ...
                <div className="bg-stone-800 sm:h-[238px
                    ...
                    <a className="button-container absolute bottom-5 right-5" href={resume} download='Allen_Bandian_Resume.pdf'>
                        <button className='bg-zinc-950/50 p-2 rounded-[50%] hover:p-3 hover:bg-zinc-700/50 transitiion duration-300  ease-in-out'>
                            <img  className='h-4 sm:h-8' src={down} alt="" />
                        </button>
                    </a>
                </div>

                <Link to="https://github.com/Grim22" target='_blank' className="bg-neutral-900 sm:h-[238px] rounded-3xl col-span-1 drop-shadow-lg flex items-center justify-center hover:bg-neutral-950">
                ...
                <Link to="https://github.com/Grim22" target='_blank' className="bg-neutral-100 sm:h-[238px] rounded-3xl drop-shadow-lg flex items-center justify-center hover:bg-neutral-200">
                    <SiIndeed className='h-[30%] w-auto text-blue-900'/>
                </Link>
                <Link to="/email" className="bg-green-400 h-[238px
                ] col-span-2 md:col-span-2 rounded-3xl drop-shadow-lg flex items-center justify-center hover:bg-green-500">
